  ...
  return (
    <div className="container mx-auto p-4 bg-white shadow-md">
      <form onSubmit={handleSubmit}>
        ...
        <button className="bg-blue-500 p-2 text-white rounded-md shadow-md hover:scale-105 hover:-translate-y-1 hover:duration-200"> 
          เพิ่มสินค้า 
        </button>
        ...
        <table className="table w-full border">
          ...
          <tbody>
            ...
            //   console.log(item);
            //   console.log("UPDATED AT:", item.updateAT)
              return (
                <tr key={index}>
                  ...
                  <td className="flex gap-2">
                    ...
                    <p
                    className="bg-red-700 rounded-md p-1 shadow-md hover:scale-105 hover:-translate-y-1 hover:duration-200"
